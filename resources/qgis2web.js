...
map.getView().fit([8527012.412594, 1035423.708115, 8544117.166029, 1046173.428619], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Aranmula</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (21 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'ARANMULA RESOURCE MAP';
            }
